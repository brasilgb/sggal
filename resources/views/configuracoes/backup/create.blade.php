...
<div class="col-lg-12">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="col-lg-6">
                {!! Form::open(['route' => 'backup.store', 'method' => 'POST', 'class' => 'form-horizontal', 'autocomplete' => 'off']) !!}

                <div class="form-group row">
                    {!! Form::label('base_dados', 'Base de dados', ['class' => 'col-lg-4 col-form-label']) !!}
                    <div class="col-lg-8">
                        {!! Form::text('base_dados', old('base_dados'), ['id' => 'base_dados', 'class' => 'form-control']) !!}
                        @error('base_dados')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        {!! Form::text('senha', old('senha'), ['id' => 'senha', 'class' => 'form-control']) !!}
                        @error('senha')
                        <div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> {{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        {!! Form::text('diretorio', old('diretorio'), ['id' => 'diretorio', 'class' => 'form-control']) !!}
                        @error('diretorio')
                        <div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> {{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        {!! Form::text('agendamento', old('agendamento'), ['id' => 'agendamento', 'class' => 'form-control']) !!}
                        @error('agendamento')
                        <div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> {{ $message }}</div>
                        @enderror
                    </div>
