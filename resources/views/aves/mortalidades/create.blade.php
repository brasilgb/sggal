    ...
    <div class="card">
        <div class="card-header border-1">
            <div class="d-flex justify-content-between">
                ...
                <!-- SEARCH FORM -->
                {!! Form::open(['url' => 'mortalidades/search', 'method' => 'POST', 'class' => 'form-inline ml-3', 'autocomplete' => 'off']) !!}
        ...
        <div class="card-body">
            ...
            <div class="col-lg-6">
                {!! Form::open(['route' => 'mortalidades.store', 'method' => 'POST', 'class' => 'form-horizontal', 'autocomplete' => 'off']) !!}

                <div class="form-group row">
                    <label class="col-lg-4 col-form-label">Data da baixa: </label>
                    <div class="col-lg-8">
                        <input id="dataform" class="form-control" type="text" name="data_mortalidade" value="<?= date("d/m/Y"); ?>">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        ...
                        <div class="info-num-aves est-aves" style="display: none;">Há <strong class="text-red"></strong> mortalidades <span></span> disponíveis no aviário.</div>
                        @error('quantiddade')
                        <div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> {{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8 text-right">
                        {!! Form::button('<i class="fa fa-smortalidade"></i> Salvar', ['type' => 'submit', 'class' => 'btn btn-primary salvar']) !!}
                    </div>
                </div>
