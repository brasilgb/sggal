        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"> Editar pesagem</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
    ...
    <div class="card">
        <div class="card-header border-1">
            <div class="d-flex justify-content-between">
                ...
                <!-- SEARCH FORM -->
                {!! Form::open(['url' => 'aves/pesos/search', 'method' => 'POST', 'class' => 'form-inline ml-3', 'autocomplete' => 'off']) !!}
        ...
        <div class="card-body">
            ...
            <div class="col-lg-6">
                {!! Form::open(['route' => ['pesos.update', 'peso' => $peso->id_peso], 'method' => 'PUT', 'class' => 'form-horizontal', 'autocomplete' => 'off']) !!}
                
                <div class="form-group row">
                    <label class="col-lg-4 col-form-label">Data de pesagem: </label>
                    <div class="col-lg-8">
                        <input id="dataform" class="form-control" type="text" name="data_peso" value="{{date('d/m/Y', strtotime($peso->data_peso))}}">
                        @error('data_peso')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        {!! Form::select('lote_id', $lotes->pluck('lote', 'id_lote'), $peso->lote_id,['id' => 'loteid', 'class' => 'form-control']) !!}
                        @error('lote_id')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        {!! Form::select('aviario_id', $aviarios($peso->lote_id)->pluck('aviario', 'id_aviario'), $peso->aviario_id, ['id' => 'aviariosdolote', 'class' => 'form-control']) !!}
                        @error('aviario_id')
                        <div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> {{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        {!! Form::select('semana', $semanas->pluck('semana', 'id_semana'), $peso->semana,['id' => 'semana', 'class' => 'form-control']) !!}
                        @error('semana')
                        <div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i>{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        {!! Form::select('sexo', ['1' => 'Fêmea', '2' => 'Macho'], $peso->sexo, ['id' => 'sexo', 'class' => 'form-control input-total']) !!}
                        @error('sexo')
                        <div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> {{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        {!! Form::text('peso', $peso->peso, ['id' => 'peso', 'class' => 'form-control input-total']) !!}
                        @error('peso')
                        <div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> {{ $message }}</div>
                        @enderror
                    </div>
