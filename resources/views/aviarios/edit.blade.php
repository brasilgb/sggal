        ...
        <div class="card-body">
            ...
            <div class="col-lg-6">
                ...
                <div class="form-group row">
                    {!! Form::label('data_aviario', 'Data aviario', ['class' => 'col-lg-5 col-label-form']) !!}
                    <div class="col-lg-7">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-7">
                        {!! Form::select('lote_id', App\Lote::pluck('lote', 'id_lote')->prepend('Selecione o lote', ''), $aviario->lote_id,['id' => 'loteid', 'class' => 'form-control']) !!}
                        @error('lote_id')
