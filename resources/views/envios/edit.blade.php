        ...
        <div class="row mb-2">
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active"> Alterar envio</li>
                </ol>
            </div><!-- /.col -->
        </div><!-- /.row -->
    </div><!-- /.container-fluid -->
...
<div class="col-lg-12">
    <div class="card">
        ...
        <div class="card-body">
            ...
            <div class="col-lg-6">
                {!! Form::open(['route' => ['envios.update', 'envio' => $envio->id_envio], 'method' => 'PUT', 'class' => 'form-horizontal', 'autocomplete' => 'off']) !!}
                <div class="form-group row">
                    <label class="col-lg-4 col-form-label">Data do envio </label>
                    <div class="col-lg-8">
                        {!! Form::text('data_envio', date('d/m/Y', strtotime($envio->data_envio)), ['id' => 'dataform', 'class' => 'form-control']) !!}
                        @error('data_envio')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        {!! Form::text('hora_envio', date("H:i", strtotime($envio->hora_envio)), ['id' => 'horaenvio', 'class' => 'form-control']) !!}
                        @error('hora_envio')
                        <div class="alert alert-danger"><i class="fa fa-exclamation-triangle"></i> {{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        {!! Form::select('lote_id', $lotes->pluck('lote', 'id_lote')->prepend('Selecione o lote', ''), $envio->lote_id,['id' => 'loteid', 'class' => 'form-control']) !!}
                        @error('lote_id')
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        {!! Form::text('incubaveis', $envio->incubaveis, ['id' => 'envioincubaveis', 'class' => 'totalenvio form-control']) !!}
                        {!! Form::hidden('numincubaveis', $envio->incubaveis, ['id' => 'numincubaveis']) !!}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        {!! Form::text('comerciais', $envio->comerciais, ['id' => 'enviocomerciais', 'class' => 'totalenvio form-control']) !!}
                        {!! Form::hidden('numcomerciais', $envio->comerciais, ['id' => 'numcomerciais']) !!}
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-8">
                        {!! Form::text('postura_dia', $envio->postura_dia, ['id' => 'totalenvio', 'class' => 'form-control']) !!}
                    </div>
                </div>
