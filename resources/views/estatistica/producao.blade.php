            ...
            <div class="table-responsive">
                <table class="table table-condensed table-striped table-hover">
                    ...
                    <tr>
                        ...
                        <td>
                            <?php $bginput = $semana->producao == true ? 'bg-info disabled' : 'bg-secondary disabled'; ?>
                            {!! Form::text('producao',$semana->producao,['id' => 'producao', 'class' => 'form-semana '.$bginput.' form-semana'.$semana->id_semana.'', 'id-semana' => $semana->id_semana, 'operacao' => 'producao', 'placeholder' => '%']) !!}
                        </td>
                    </tr>
                    @empty
